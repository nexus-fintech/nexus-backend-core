package com.nexus.backend.iam.interfaces.acl;
...
public class IamContextFacade {
   ...
   *
   * @param userCommandService The UserCommandService to be used by the facade.
   * @param userQueryService The UserQueryService to be used by the facade.
   */
